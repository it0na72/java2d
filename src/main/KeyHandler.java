    ...
    public void titleState(int code)
    {
        ...
        //SECOND SCREEN // CHARACTER SELECTION
            ...
            if (code == KeyEvent.VK_ENTER) {
                //FIGHTER
                if (gp.ui.commandNum == 0) {
                    System.out.println("Do some fighter specific stuff!"); // maybe add more in the future
                    gp.gameState = gp.playState;
                    gp.playMusic(0);
                }
                //THIEF
                if (gp.ui.commandNum == 1) {
                    System.out.println("Do some thief specific stuff!"); // maybe add more in the future
                    gp.gameState = gp.playState;
                    gp.playMusic(0);
                }
                //SORCERER
                if (gp.ui.commandNum == 2) {
                    System.out.println("Do some sorcerer specific stuff!"); // maybe add more in the future
                    gp.gameState = gp.playState;
                    gp.playMusic(0);
                }
                //BACK
        ...
        if(code == KeyEvent.VK_A)
        {
            if(gp.ui.subState == 0)
            {
                if(gp.ui.commandNum == 1 && gp.music.volumeScale > 0) //music
                {
                    ...
                    gp.music.checkVolume();  //check for music maybe a song is already being played. Dont need it for SE, when set a sound checkVolume will be executed.
                    gp.playSE(9);
                }
